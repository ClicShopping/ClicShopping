...
class ConversationMemory
{
  ...
  private function loadRecentHistory(): void
  {
    try {
      ...
      $groupedResults = $this->chunkReconstructor->groupChunksByInteraction($results);
      $recentInteractions = $this->chunkReconstructor->reconstructInteractions($groupedResults, $this->maxHistorySize);
