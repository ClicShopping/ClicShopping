 ...
 *
 * Stages are registered (and re-ordered) through {@see StageRegistry}. Because both the interface
 * and the context are agnostic, a domain App can implement its own stage and register it via the
 * registry — the same agnostic extension pattern used elsewhere (e.g. WebSearchEngineRegistry) —
