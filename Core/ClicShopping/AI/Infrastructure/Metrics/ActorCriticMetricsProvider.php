...
class ActorCriticMetricsProvider
{
  ...
  public function getRegistryStats(): array
  {
    try {
      ...
      error_log('ActorCriticMetricsProvider: Failed to get registry stats - ' . $e->getMessage());
      return [
        'total_actors' => 0,
        'total_critics' => 0,
        'separation_ratio' => 0,
  ...
  public function getActorMetrics(int $periodDays = 7): array
  {
    try {
      ...
      error_log('ActorCriticMetricsProvider: Failed to get actor metrics - ' . $e->getMessage());
      return [
        'total_executions' => 0,
  ...
  public function getCriticMetrics(int $periodDays = 7): array
  {
    try {
      ...
      error_log('ActorCriticMetricsProvider: Failed to get critic metrics - ' . $e->getMessage());
      return [
        'total_evaluations' => 0,
  ...
  public function getCoordinationMetrics(int $periodDays = 7): array
  {
    try {
      ...
      error_log('ActorCriticMetricsProvider: Failed to get coordination metrics - ' . $e->getMessage());
      return [
  ...
  public function getUtilizationMetrics(int $periodDays = 7): array
  {
    try {
      ...
      error_log('ActorCriticMetricsProvider: Failed to get utilization metrics - ' . $e->getMessage());
      return [
        'actor_utilization' => 0,
  ...
  public function getRecentCoordinations(int $limit = 20): array
  {
    try {
      ...
      error_log('ActorCriticMetricsProvider: Failed to get recent coordinations - ' . $e->getMessage());
      return [];
    }
  }
  ...
  public function getActorDetails(string $actorId): array
  {
    try {
      ...
      error_log('ActorCriticMetricsProvider: Failed to get actor details - ' . $e->getMessage());
      return [
        'actor_id' => $actorId,
        'capabilities' => [],
        'total_executions' => 0,
  ...
  public function getCriticDetails(string $criticId): array
  {
    try {
      ...
      error_log('ActorCriticMetricsProvider: Failed to get critic details - ' . $e->getMessage());
      return [
        'critic_id' => $criticId,
        'capabilities' => [],
        'total_evaluations' => 0,
