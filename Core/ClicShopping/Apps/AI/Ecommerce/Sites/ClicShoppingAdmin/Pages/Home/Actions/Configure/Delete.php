...
namespace ClicShopping\Apps\AI\Ecommerce\Sites\ClicShoppingAdmin\Pages\Home\Actions\Configure;
...
class Delete extends \ClicShopping\OM\Domains\ConfigureActionsAbstract
{
  ...
  private static function removeMenu(): void
  {
    ...
    if ($Qcheck->fetch()) {
      ...
      $QMenuId->bindValue(':app_code', 'app_ai_ecommerce');
      $QMenuId->execute();
      ...
      $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_ai_ecommerce']);
    }
  }
}