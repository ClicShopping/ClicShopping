...
namespace ClicShopping\Apps\AI\Ecommerce\Module\ClicShoppingAdmin\Config\EC;
 ...
 *   'MODULE_MODULES_ECOMMERCE_INSTALLED'.
 */
class EC extends \ClicShopping\Apps\AI\Ecommerce\Module\ClicShoppingAdmin\Config\ConfigAbstract
{
  ...
  protected function init()
  {
    ...
    $this->is_installed = \defined('CLICSHOPPING_APP_ECOMMERCE_EC_STATUS') && (trim(CLICSHOPPING_APP_ECOMMERCE_EC_STATUS) != '');
  }
