...
class shared_key_retail extends \ClicShopping\Apps\AI\Ecommerce\Module\ClicShoppingAdmin\Config\ConfigParamAbstract
{
  ...
  {
    $this->title = $this->app->getDef('cfg_ecommerce_acp_api_shared_key_retails_title');
    $this->description = $this->app->getDef('cfg_ecommerce_acp_api_shared_key_retails_description');
  }
