...
namespace ClicShopping\Apps\AI\Ecommerce\Module\Hooks\ClicShoppingAdmin\Featured;
...
class DeleteAll implements HooksInterface
{
  ...
  public function execute()
  {
    ...
    if (isset($_POST['selected'], $_GET['Featured'])) {
  ...
  private function clearCockpitCache(int $productId): void
  {
    ...
    if (defined('CLICSHOPPING_APP_ECOMMERCE_CAI_DEBUG') && CLICSHOPPING_APP_ECOMMERCE_CAI_DEBUG === 'True') {
      error_log("[CockpitAI] Featured DeleteAll: refresh flag set for product $productId");
    }
  }
}