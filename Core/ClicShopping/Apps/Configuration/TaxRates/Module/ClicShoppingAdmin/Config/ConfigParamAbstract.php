...
abstract class ConfigParamAbstract extends \ClicShopping\Sites\ClicShoppingAdmin\ConfigParamAbstract
{
  ...
  protected string $key_prefix = 'clicshopping_app_tax_rates_';
  public bool $app_configured = true;

  /**
   * Constructor method for initializing the configuration module.
   *
   * @param string $config_module The configuration module name used to set key prefix, config module, and load definitions.
   * @return void
   */
