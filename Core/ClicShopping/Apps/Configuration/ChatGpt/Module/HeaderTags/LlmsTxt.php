<?php
  ...
  namespace ClicShopping\Apps\Configuration\ChatGpt\Module\HeaderTags;
  ...
  use ClicShopping\Apps\Configuration\ChatGpt\Classes\Shop\Llms\Llms;

  final class LlmsTxt extends HeaderTagsAbstract
  {
    private ChatGptApp $app;
    private ?Llms $llmsTxt = null;
    public string $group;
