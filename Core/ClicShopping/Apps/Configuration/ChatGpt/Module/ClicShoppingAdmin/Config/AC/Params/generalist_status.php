<?php
/**
 * Generalist Critic Configuration Parameter
 *
...
/**
 * Generalist Critic Parameter
 * 
 * Controls activation of the Generalist critic.
 * Provides broad evaluation across all domains without specific specialization.
 * 
 * @package ClicShopping\Apps\Configuration\ChatGpt\Module\ClicShoppingAdmin\Config\AgentCritics\Params
 * @since 4.2.0
 */
class generalist_status extends \ClicShopping\Apps\Configuration\ChatGpt\Module\ClicShoppingAdmin\Config\ConfigParamAbstract
{
  public $default = 'True';
  ...
  {
    $this->title = $this->app->getDef('cfg_chatgpt_generalist_status_title');
    $this->description = $this->app->getDef('cfg_chatgpt_generalist_status_description');
  }
