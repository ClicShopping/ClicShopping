...
class TotalToken extends AdminDashboardAbstract
{
  public mixed $lang;
  public mixed $app;
  public $group;
  ...
  protected function init()
  {
    ...
    if (\defined('MODULE_ADMIN_DASHBOARD_TOTAL_GPT_TOKEN_APP_STATUS')) {
      $this->sort_order = defined('MODULE_ADMIN_DASHBOARD_TOTAL_GPT_TOKEN_APP_SORT_ORDER') ? (int)MODULE_ADMIN_DASHBOARD_TOTAL_GPT_TOKEN_APP_SORT_ORDER : 0;
