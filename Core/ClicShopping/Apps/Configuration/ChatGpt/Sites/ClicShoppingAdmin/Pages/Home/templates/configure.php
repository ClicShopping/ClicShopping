          ...
          <?php
            if (\defined('CLICSHOPPING_APP_CHATGPT_RA_STATUS')) {
              ...
              if (empty($result) || $result === false) {
                ...
                echo HTML::button($CLICSHOPPING_ChatGpt->getDef('module_ch_sql_update'), null, $CLICSHOPPING_ChatGpt->link('ChatGpt'), 'warning',  ['params' => 'data-confirm-text="' . $CLICSHOPPING_ChatGpt->getDef('module_ch_confirmation') . '"']) . ' ';
                echo '</form>';
              }
            }
