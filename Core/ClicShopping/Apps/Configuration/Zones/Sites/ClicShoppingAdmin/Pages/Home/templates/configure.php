...
$CLICSHOPPING_Zones_Config = Registry::get('ZonesAdminConfig' . $current_module);

if ($CLICSHOPPING_MessageStack->exists('Zones')) {
  echo $CLICSHOPPING_MessageStack->get('Zones');
}
?>
...
<div class="contentBody">
  ...
  <?php
  if ($CLICSHOPPING_Zones_Config->is_installed === true) {
    ?>
    <form name="ConfigurationZonesConfigure"
          action="<?php echo $CLICSHOPPING_Zones->link('Configure&Process&module=' . $current_module); ?>"
          method="post">

      <div class="mainTitle">
        <?php echo $CLICSHOPPING_Zones->getConfigModuleInfo($current_module, 'title'); ?>
      </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo $CLICSHOPPING_Zones->getDef('dialog_uninstall_body'); ?>
            </div>
    ...
    <div class="col-md-12 mainTitle">
      <strong><?php echo $CLICSHOPPING_Zones->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
    <div class="adminformTitle">
      <div class="row">
        <div class="mt-1"></div>
        <div class="col-md-12">
          <div><?php echo $CLICSHOPPING_Zones->getConfigModuleInfo($current_module, 'introduction'); ?></div>
          <div class="mt-1"></div>
          <div><?php echo HTML::button($CLICSHOPPING_Zones->getDef('button_install_title', ['title' => $CLICSHOPPING_Zones->getConfigModuleInfo($current_module, 'title')]), null, $CLICSHOPPING_Zones->link('Configure&Install&module=' . $current_module), 'warning'); ?></div>
        </div>
      </div>
    </div>
    <?php
