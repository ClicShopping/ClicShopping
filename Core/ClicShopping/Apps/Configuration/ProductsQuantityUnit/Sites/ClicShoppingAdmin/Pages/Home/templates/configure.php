...
<div class="contentBody">
    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span
            class="col-md-4 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_ProductsQuantityUnit->getDef('heading_title'); ?></span>
  ...
  if ($CLICSHOPPING_ProductsQuantityUnit_Config->is_installed === true) {
    ?>
    <form name="ConfigurationProductsQuantityUnitConfigure"
          action="<?php echo $CLICSHOPPING_ProductsQuantityUnit->link('Configure&Process&module=' . $current_module); ?>"
          method="post">
      ...
      <div class="col-md-12">
        ...
        if ($CLICSHOPPING_ProductsQuantityUnit->getConfigModuleInfo($current_module, 'is_uninstallable') === true) {
          echo '<span class="float-end">' . HTML::button($CLICSHOPPING_ProductsQuantityUnit->getDef('button_dialog_uninstall'), null, '#', 'warning', ['params' => 'data-bs-toggle="modal" data-bs-target="#ppUninstallModal"']) . '</span>';
        }
        ?>
      </div>
    </form>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4
                class="modal-title"><?php echo $CLICSHOPPING_ProductsQuantityUnit->getDef('dialog_uninstall_title'); ?></h4>
            </div>
            ...
            <div class="modal-footer">
              ...
              <?php echo HTML::button($CLICSHOPPING_ProductsQuantityUnit->getDef('button_cancel'), null, '#', 'warning', ['params' => 'data-bs-dismiss="modal"']); ?>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-12 mainTitle">
      <strong><?php echo $CLICSHOPPING_ProductsQuantityUnit->getConfigModuleInfo($current_module, 'title'); ?></strong>
    </div>
    <div class="adminformTitle">
      <div class="row">
        <div class="mt-1"></div>
