...
namespace ClicShopping\Apps\Configuration\Currency\Module\ClicShoppingAdmin\Config\CR;

class CR extends \ClicShopping\Apps\Configuration\Currency\Module\ClicShoppingAdmin\Config\ConfigAbstract
{

  protected $pm_code = 'currency';
