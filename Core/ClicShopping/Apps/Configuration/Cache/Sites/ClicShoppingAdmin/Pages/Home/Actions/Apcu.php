...
class Apcu extends \ClicShopping\OM\Domains\PagesActionsAbstract
{
  public function execute()
  {
    $CLICSHOPPING_Cache = Registry::get('Cache');

    $this->page->setFile('apcu.php');
    $this->page->data['action'] = 'Cache';

    $CLICSHOPPING_Cache->loadDefinitions('Sites/ClicShoppingAdmin/apcu');
  }
}
