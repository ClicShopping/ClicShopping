...
class status extends \ClicShopping\Apps\Configuration\Modules\Module\ClicShoppingAdmin\Config\ConfigParamAbstract
{
  public $default = 'True';
  ...
  {
    $this->title = $this->app->getDef('cfg_products_modules_status_title');
    $this->description = $this->app->getDef('cfg_products_modules_status_description');
  }
