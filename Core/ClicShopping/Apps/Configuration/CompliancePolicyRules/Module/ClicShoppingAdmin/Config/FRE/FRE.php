...
namespace ClicShopping\Apps\Configuration\CompliancePolicyRules\Module\ClicShoppingAdmin\Config\FRE;
 ...
 */
class FRE extends ConfigAbstract
{
  ...
  {
    $this->title = $this->app->getDef('module_french_title');
    $this->short_title = $this->app->getDef('module_french_short_title');
    $this->introduction = $this->app->getDef('module_french_introduction');
    $this->is_installed = \defined('CLICSHOPPING_APP_COMPLIANCE_POLICY_RULES_FRE_STATUS') && (trim(CLICSHOPPING_APP_COMPLIANCE_POLICY_RULES_FRE_STATUS) != '');
  }
