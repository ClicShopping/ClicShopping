...
class Delete extends \ClicShopping\OM\Domains\ConfigureActionsAbstract
{
  ...
  private static function removeMenu(): void
  {
    ...
    if ($Qcheck->fetch()) {
      ...
      $QMenuId->bindValue(':app_code', 'app_configuration_complicance_policy_rules');
      $QMenuId->execute();
      ...
      $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_configuration_complicance_policy_rules']);
    }
  }
}