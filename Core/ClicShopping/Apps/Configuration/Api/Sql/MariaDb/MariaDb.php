...
namespace ClicShopping\Apps\Configuration\Api\Sql\MariaDb;
...
CREATE TABLE :table_api (
  ...
  get_product_status tinyint(1) NOT NULL default(0),
  update_product_status tinyint(1) NOT NULL default(0),
  insert_product_status tinyint(1) NOT NULL default(0),
  delete_product_status tinyint(1) NOT NULL default(0),
  get_categories_status tinyint(1) NOT NULL default(0),
  update_categories_status tinyint(1) NOT NULL default(0),
  insert_categories_status tinyint(1) NOT NULL default(0),
  delete_categories_status tinyint(1) NOT NULL default(0),
  get_customer_status tinyint(1) NOT NULL default(0),
  update_customer_status tinyint(1) NOT NULL default(0),
  insert_customer_status tinyint(1) NOT NULL default(0),
  delete_customer_status tinyint(1) NOT NULL default(0),
  get_order_status tinyint(1) NOT NULL default(0),
  update_order_status tinyint(1) NOT NULL default(0),
  insert_order_status tinyint(1) NOT NULL default(0),
  delete_order_status tinyint(1) NOT NULL default(0),
  get_manufacturer_status tinyint(1) NOT NULL default(0),
  update_manufacturer_status tinyint(1) NOT NULL default(0),
  insert_manufacturer_status tinyint(1) NOT NULL default(0),
  delete_manufacturer_status tinyint(1) NOT NULL default(0),
  get_supplier_status tinyint(1) NOT NULL default(0),
  update_supplier_status tinyint(1) NOT NULL default(0),
  insert_supplier_status tinyint(1) NOT NULL default(0),
  delete_supplier_status tinyint(1) NOT NULL default(0),
  PRIMARY KEY (api_id)
