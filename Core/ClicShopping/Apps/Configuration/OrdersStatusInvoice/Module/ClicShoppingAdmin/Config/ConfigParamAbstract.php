...
abstract class ConfigParamAbstract extends \ClicShopping\Sites\ClicShoppingAdmin\ConfigParamAbstract
{
  ...
  protected string $key_prefix = 'clicshopping_app_orders_status_invoice_';
  public bool $app_configured = true;

  /**
   * Constructor method for initializing the configuration module and loading necessary definitions.
   *
   * @param string $config_module The configuration module for which this class is being instantiated.
   * @return void
   */
