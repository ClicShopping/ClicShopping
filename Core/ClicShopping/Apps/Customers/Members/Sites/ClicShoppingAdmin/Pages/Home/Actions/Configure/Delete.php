...
class Delete extends \ClicShopping\OM\Domains\ConfigureActionsAbstract
{
  ...
  private static function removeMenu(): void
  {
    ...
    $Qcheck = $CLICSHOPPING_Db->get('administrator_menu', 'app_code', ['app_code' => 'app_customers_members']);
    ...
    if ($Qcheck->fetch()) {
      ...
      $QMenuId->bindValue(':app_code', 'app_customers_members');
      $QMenuId->execute();
      ...
      $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_customers_members']);
    }
  }
}