...
$CLICSHOPPING_Specials_Config = Registry::get('SpecialsAdminConfig' . $current_module);
...
<div class="contentBody">
    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span
            class="col-md-4 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_Specials->getDef('heading_title'); ?></span>
          <span class="col-md-7 text-end">
            <?php echo HTML::button($CLICSHOPPING_Specials->getDef('button_specials'), null, $CLICSHOPPING_Specials->link('Specials'), 'success'); ?>
        </div>
      </div>
    </div>
  </div>
  ...
  <?php
  if ($CLICSHOPPING_Specials_Config->is_installed === true) {
    ?>
    <form name="MarketingSpecialsConfigure"
          action="<?php echo $CLICSHOPPING_Specials->link('Configure&Process&module=' . $current_module); ?>"
          method="post">

      <div class="mainTitle">
        <?php echo $CLICSHOPPING_Specials->getConfigModuleInfo($current_module, 'title'); ?>
      </div>
      ...
      <div class="col-md-12">
        ...
        if ($CLICSHOPPING_Specials->getConfigModuleInfo($current_module, 'is_uninstallable') === true) {
          echo '<span class="float-end">' . HTML::button($CLICSHOPPING_Specials->getDef('button_dialog_uninstall'), null, '#', 'warning', ['params' => 'data-bs-toggle="modal" data-bs-target="#ppUninstallModal"']) . '</span>';
        }
        ?>
      </div>
    </form>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><?php echo $CLICSHOPPING_Specials->getDef('dialog_uninstall_title'); ?></h4>
            </div>
            <div class="modal-body">
              <?php echo $CLICSHOPPING_Specials->getDef('dialog_uninstall_body'); ?>
            </div>
            <div class="modal-footer">
              <?php echo HTML::button($CLICSHOPPING_Specials->getDef('button_delete'), null, $CLICSHOPPING_Specials->link('Configure&Delete&module=' . $current_module), 'danger'); ?>
              <?php echo HTML::button($CLICSHOPPING_Specials->getDef('button_uninstall'), null, $CLICSHOPPING_Specials->link('Configure&Uninstall&module=' . $current_module), 'danger'); ?>
              <?php echo HTML::button($CLICSHOPPING_Specials->getDef('button_cancel'), null, '#', 'warning', ['params' => 'data-bs-dismiss="modal"']); ?>
            </div>
          </div>
        </div>
      </div>
