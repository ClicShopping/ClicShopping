...
<div class="contentBody">
  ...
  <div class="mt-1"></div>
  <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_SEO->getDef('text_seo'); ?></strong></div>
  <div class="adminformTitle">
    <div class="row">
      ...
      <div class="col-md-12">
        <div>
          <div class="col-md-12">
            <?php echo $CLICSHOPPING_SEO->getDef('text_intro'); ?>
          </div>
        </div>
        ...
        <div class="col-md-12">
          <div>
            <div class="col-md-12 text-center">
              <?php
              echo HTML::form('configure', CLICSHOPPING::link(null, 'A&Marketing\SEO&Configure'));
              echo HTML::button($CLICSHOPPING_SEO->getDef('button_configure'), null, null, 'primary');
              echo '</form>';
              ?>
            </div>
          </div>
