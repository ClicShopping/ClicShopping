...
<div class="contentBody">
  ...
  if ($CLICSHOPPING_SEO_Config->is_installed === true) {
    ?>
    <form name="MarketingSEOConfigure"
          action="<?php echo $CLICSHOPPING_SEO->link('Configure&Process&module=' . $current_module); ?>"
          method="post">
      ...
      <div class="col-md-12">
        ...
        if ($CLICSHOPPING_SEO->getConfigModuleInfo($current_module, 'is_uninstallable') === true) {
          echo '<span class="float-end">' . HTML::button($CLICSHOPPING_SEO->getDef('button_dialog_uninstall'), null, '#', 'warning', ['params' => 'data-bs-toggle="modal" data-bs-target="#ppUninstallModal"']) . '</span>';
        }
        ?>
      </div>
    </form>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <?php echo HTML::button($CLICSHOPPING_SEO->getDef('button_cancel'), null, '#', 'warning', ['params' => 'data-bs-dismiss="modal"']); ?>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-12 mainTitle">
      <strong><?php echo $CLICSHOPPING_SEO->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
    <div class="adminformTitle">
      <div class="row">
        <div class="mt-1"></div>
        <div class="col-md-12">
