...
class order_status_id extends \ClicShopping\Apps\Payment\Stripe\Module\ClicShoppingAdmin\Config\ConfigParamAbstract
{
  ...
  {
    $this->title = $this->app->getDef('cfg_stripe_order_status_id_title');
    $this->description = $this->app->getDef('cfg_stripe_order_status_id_desc');
  }
  ...
  public function getInputField()
  {
    ...
    $statuses_array = [
      [
        'id' => '0',
        'text' => $this->app->getDef('cfg_stripe_order_status_id_default')
      ]
    ];
