...
class zone extends \ClicShopping\Apps\Payment\Stripe\Module\ClicShoppingAdmin\Config\ConfigParamAbstract
{
  public $default = '0';
  ...
  {
    $this->title = $this->app->getDef('cfg_stripe_zone_title');
    $this->description = $this->app->getDef('cfg_stripe_zone_desc');
  }
  ...
  public function getInputField()
  {
    ...
    $zone_class_array = [
      [
        'id' => '0',
        'text' => $this->app->getDef('cfg_stripe_zone_global')
      ]
    ];
