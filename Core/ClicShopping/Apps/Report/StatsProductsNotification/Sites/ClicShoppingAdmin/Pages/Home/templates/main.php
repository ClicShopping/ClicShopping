...
<div class="contentBody">
  ...
  <div class="col-md-12 mainTitle">
    <strong><?php echo $CLICSHOPPING_StatsProductsNotification->getDef('text_stats_products_notification'); ?></strong>
  </div>
  <div class="adminformTitle">
    <div class="row">
      ...
      <div class="col-md-12">
        <div>
          <div class="col-md-12">
            <?php echo $CLICSHOPPING_StatsProductsNotification->getDef('text_intro'); ?>
          </div>
        </div>
        <div class="mt-1"></div>
        ...
        <div class="col-md-12 text-center">
          <div>
            <div class="col-md-12">
              <?php
              echo HTML::form('configure', CLICSHOPPING::link(null, 'A&Report\StatsProductsNotification&Configure'));
              echo HTML::button($CLICSHOPPING_StatsProductsNotification->getDef('button_configure'), null, null, 'primary');
              echo '</form>';
              ?>
            </div>
          </div>
