...
$CLICSHOPPING_StatsProductsNotification_Config = Registry::get('StatsProductsNotificationAdminConfig' . $current_module);
...
<div class="contentBody">
  ...
  if ($CLICSHOPPING_StatsProductsNotification_Config->is_installed === true) {
    ...
    <form name="CustomersCustomersConfigure"
          action="<?php echo $CLICSHOPPING_StatsProductsNotification->link('Configure&Process&module=' . $current_module); ?>"
          method="post">

      <div class="mainTitle">
        <?php echo $CLICSHOPPING_StatsProductsNotification->getConfigModuleInfo($current_module, 'title'); ?>
      </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo $CLICSHOPPING_StatsProductsNotification->getDef('dialog_uninstall_body'); ?>
            </div>
    ...
    <div class="col-md-12 mainTitle">
      <strong><?php echo $CLICSHOPPING_StatsProductsNotification->getConfigModuleInfo($current_module, 'title'); ?></strong>
    </div>
    <div class="adminformTitle">
      <div class="row">
        <div class="mt-1"></div>
        <div class="col-md-12">
          <div><?php echo $CLICSHOPPING_StatsProductsNotification->getConfigModuleInfo($current_module, 'introduction'); ?></div>
          <div class="separator">
            <div><?php echo HTML::button($CLICSHOPPING_StatsProductsNotification->getDef('button_install_title', ['title' => $CLICSHOPPING_StatsProductsNotification->getConfigModuleInfo($current_module, 'title')]), null, $CLICSHOPPING_StatsProductsNotification->link('Configure&Install&module=' . $current_module), 'warning'); ?></div>
          </div>
        </div>
      </div>
    </div>
