...
<div class="contentBody">
  ...
  <table
    ...
    <tr>
      ...
      <th data-field="qty" data-sortable="true"
          class="text-center"><?php echo $CLICSHOPPING_Products->getDef('table_heading_qty'); ?></th>
      <th data-field="alert" data-sortable="true"
          class="text-center"><?php echo $CLICSHOPPING_Products->getDef('table_heading_qty_alert'); ?></th>
      <th data-field="safety" data-sortable="true"
          class="text-center"><?php echo $CLICSHOPPING_Products->getDef('table_heading_safety_stock'); ?></th>
      ...
      while ($Qproducts->fetch()) {
        ...
        if ($safety_stock > 0) {
          ...
          <tr>
            ...
            <td><?php echo $Qproducts->valueInt('products_quantity'); ?></td>
