...
class ProductsNews extends HeaderTagsAbstract
{
  public mixed $lang;
  public mixed $app;
  public mixed $group;
...
EOD;
  ...
  public function Install()
  {
    ...
    $this->app->db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_HEADER_TAGS_PRODUCT_PRODUCTS_NEWS_DISPLAY_PAGES',
  ...
  public function keys()
  {
    return ['MODULE_HEADER_TAGS_PRODUCT_PRODUCTS_NEWS_STATUS',
      ...
      'MODULE_HEADER_TAGS_PRODUCT_PRODUCTS_NEWS_DISPLAY_PAGES'
    ];
  }
}
