  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          <span
            class="col-md-1 logoHeading"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . 'categories/produit.gif', $CLICSHOPPING_ProductsAttributes->getDef('heading_title'), '40', '40'); ?></span>
          <span
...
?>
  ...
  if ($CLICSHOPPING_ProductsAttributes_Config->is_installed === true) {
    ...
    <form name="CustomersCustomersConfigure"
      ...
      <div class="mainTitle">
        <?php echo $CLICSHOPPING_ProductsAttributes->getConfigModuleInfo($current_module, 'title'); ?>
      </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4
                class="modal-title"><?php echo $CLICSHOPPING_ProductsAttributes->getDef('dialog_uninstall_title'); ?></h4>
            </div>
            <div class="modal-body">
              <?php echo $CLICSHOPPING_ProductsAttributes->getDef('dialog_uninstall_body'); ?>
            </div>
            <div class="modal-footer">
              <?php echo HTML::button($CLICSHOPPING_ProductsAttributes->getDef('button_delete'), null, $CLICSHOPPING_ProductsAttributes->link('Configure&Delete&module=' . $current_module), 'danger'); ?>
              <?php echo HTML::button($CLICSHOPPING_ProductsAttributes->getDef('button_uninstall'), null, $CLICSHOPPING_ProductsAttributes->link('Configure&Uninstall&module=' . $current_module), 'danger'); ?>
              <?php echo HTML::button($CLICSHOPPING_ProductsAttributes->getDef('button_cancel'), null, '#', 'warning', ['params' => 'data-bs-dismiss="modal"']); ?>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="col-md-12 mainTitle">
    <strong><?php echo $CLICSHOPPING_ProductsAttributes->getConfigModuleInfo($current_module, 'title'); ?></strong>
  </div>
  <div class="adminformTitle">
    <div class="row">
      <div class="mt-1"></div>
      <div class="col-md-12">
        <div><?php echo $CLICSHOPPING_ProductsAttributes->getConfigModuleInfo($current_module, 'introduction'); ?></div>
        <div class="separator">
          <div><?php echo HTML::button($CLICSHOPPING_ProductsAttributes->getDef('button_install_title', ['title' => $CLICSHOPPING_ProductsAttributes->getConfigModuleInfo($current_module, 'title')]), null, $CLICSHOPPING_ProductsAttributes->link('Configure&Install&module=' . $current_module), 'warning'); ?></div>
        </div>
      </div>
    </div>
    <?php
