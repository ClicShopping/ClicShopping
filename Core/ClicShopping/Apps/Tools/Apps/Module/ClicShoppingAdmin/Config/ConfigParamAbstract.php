...
abstract class ConfigParamAbstract extends \ClicShopping\Sites\ClicShoppingAdmin\ConfigParamAbstract
{
  ...
  protected string $key_prefix = 'clicshopping_app_apps_';
  public bool $app_configured = true;

  /**
   * Constructor for the class.
   *
   * @param string $config_module The configuration module name, used to set up the key prefix and load definitions.
   * @return void
   */
