...
<div class="contentBody">
    ...
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          ...
          <span
            class="col-md-4 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_AdministratorMenu->getDef('heading_title'); ?></span>
          <span
            class="col-md-7 text-end"><?php echo HTML::button($CLICSHOPPING_AdministratorMenu->getDef('button_administrator_menu'), null, $CLICSHOPPING_AdministratorMenu->link('AdministratorMenu'), 'success'); ?></span>
        </div>
      </div>
    </div>
  </div>
  ...
  if ($CLICSHOPPING_AdministratorMenu_Config->is_installed === true) {
    ?>
    <form name="ToolsAdministratorMenuConfigure"
          action="<?php echo $CLICSHOPPING_AdministratorMenu->link('Configure&Process&module=' . $current_module); ?>"
          method="post">
      ...
      <div class="col-md-12">
        ...
        if ($CLICSHOPPING_AdministratorMenu->getConfigModuleInfo($current_module, 'is_uninstallable') === true) {
          echo '<span class="float-end">' . HTML::button($CLICSHOPPING_AdministratorMenu->getDef('button_dialog_uninstall'), null, '#', 'warning', ['params' => 'data-bs-toggle="modal" data-bs-target="#ppUninstallModal"']) . '</span>';
        }
        ?>
      </div>
    </form>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4
                class="modal-title"><?php echo $CLICSHOPPING_AdministratorMenu->getDef('dialog_uninstall_title'); ?></h4>
            </div>
            ...
            <div class="modal-footer">
              ...
              <?php echo HTML::button($CLICSHOPPING_AdministratorMenu->getDef('button_cancel'), null, '#', 'warning', ['params' => 'data-bs-dismiss="modal"']); ?>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-12 mainTitle">
      <strong><?php echo $CLICSHOPPING_AdministratorMenu->getConfigModuleInfo($current_module, 'title'); ?></strong>
    </div>
    <div class="adminformTitle">
      <div class="row">
        <div class="mt-1"></div>
