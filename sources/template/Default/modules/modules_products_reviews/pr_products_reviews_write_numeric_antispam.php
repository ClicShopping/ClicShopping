      ...
      if (\defined('CLICSHOPPING_APP_ANTISPAM_AM_STATUS') && CLICSHOPPING_APP_ANTISPAM_AM_STATUS == 'True') {
        if (\defined('CLICSHOPPING_APP_ANTISPAM_AM_REVIEWS_WRITE') && CLICSHOPPING_APP_ANTISPAM_AM_REVIEWS_WRITE == 'True') {
          if (\defined('MODULES_PRODUCTS_REVIEWS_WRITE_NUMERIC_ANTISPAM_STATUS')) {
            $this->enabled = \defined('MODULES_PRODUCTS_REVIEWS_WRITE_NUMERIC_ANTISPAM_STATUS') ? (MODULES_PRODUCTS_REVIEWS_WRITE_NUMERIC_ANTISPAM_STATUS == 'True') : false;
            $this->sort_order = \defined('MODULES_PRODUCTS_REVIEWS_WRITE_NUMERIC_ANTISPAM_SORT_ORDER') ? (int)MODULES_PRODUCTS_REVIEWS_WRITE_NUMERIC_ANTISPAM_SORT_ORDER : 0;
          } else {
            $this->enabled = false;
          }
        }
