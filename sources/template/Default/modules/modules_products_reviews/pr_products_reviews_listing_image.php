...
class pr_products_reviews_listing_image
{
  public string $code;
  public string $group;
  public $title;
  ...
  public function __construct()
  {
    ...
    $this->title = CLICSHOPPING::getDef('modules_products_reviews_listing_image_title');
  ...
  public function execute()
  {
    ...
    if (isset($_GET['Products'], $_GET['Reviews'])) {
      ...
      ob_start();
      require_once($CLICSHOPPING_Template->getTemplateModules($this->group . '/content/products_reviews_listing_image'));

      $data .= ob_get_clean();

      $data .= '<!-- pr_products_reviews_listing_image end -->' . "\n";
  ...
  {
    return \defined('MODULES_PRODUCTS_REVIEWS_LISTING_IMAGE_STATUS');
  }
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULES_PRODUCTS_REVIEWS_LISTING_IMAGE_STATUS',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULES_PRODUCTS_REVIEWS_LISTING_IMAGE_CONTENT_WIDTH',
