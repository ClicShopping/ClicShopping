      ...
      <div class="accordion" id="<?php echo $uniqueId; ?>">
        <?php
          ...
          foreach ($faq_data as $item) {
            ...
            $question = html_entity_decode(HTML::outputProtected($item['q']), ENT_QUOTES | ENT_HTML5, 'UTF-8');
            $answer = html_entity_decode(HTML::outputProtected($item['a']), ENT_QUOTES | ENT_HTML5, 'UTF-8');
