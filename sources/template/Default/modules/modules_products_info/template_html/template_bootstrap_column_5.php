...
<div class="col-12 col-sm-<?php echo $bootstrap_column; ?> col-md-<?php echo $bootstrap_column; ?> p-1">
  ...
  <div class="card card-height">
    <div class="ModulesProductsInfoBoostrapColumn5CardHeight">
      <div class="mt-1"></div>
      ...
      <div class="card-body">
        ...
        if (!empty($products_short_description)) {
          ?>
          <div class="ModulesProductsInfoBoostrapColumn5ShortDescription">
      ...
      <div>
        ...
        if (!empty($min_order_quantity_products_display)) {
          ?>
          <div
            class="ModulesProductsInfoBoostrapColumn5QuantityMinOrder"><?php echo $min_order_quantity_products_display; ?></div>
          <?php
        }
      ...
      <div>
        <div
          class="ModulesProductsInfoBoostrapColumn5TextPrice"><?php echo CLICSHOPPING::getDef('text_price') . ' ' . $product_price; ?></div>
      </div>
      <?php echo $form; ?>
      <div class="form-group form-group-center">
        <span class="ModulesProductsInfoBoostrapColumn5QuantityMinOrder"><?php echo $input_quantity; ?>&nbsp; </span>
        <span
          class="ModulesProductsInfoBoostrapColumn5ViewDetails"><?php echo $button_small_view_details; ?>&nbsp; </span>
        <span class="ModulesProductsInfoBoostrapColumn5SubmitButton"><label
            for="ModulesProductsInfoBoostrapColumn5SubmitButton"><?php echo $submit_button; ?></label></span>
      </div>
      <?php echo $endform; ?>
    </div>
  </div>
