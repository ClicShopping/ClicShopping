...
class cs_checkout_shipping_comment
{
  ...
  public function __construct()
  {
    ...
    if (\defined('MODULE_CHECKOUT_SHIPPING_COMMENT_STATUS')) {
      $this->sort_order = defined('MODULE_CHECKOUT_SHIPPING_COMMENT_SORT_ORDER') ? (int)MODULE_CHECKOUT_SHIPPING_COMMENT_SORT_ORDER : 0;
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CHECKOUT_SHIPPING_COMMENT_STATUS',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CHECKOUT_SHIPPING_COMMENT_CONTENT_WIDTH',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CHECKOUT_SHIPPING_COMMENT_SORT_ORDER',
