...
class cap_create_account_pro_success
{
  ...
  public function __construct()
  {
    ...
    $this->title = CLICSHOPPING::getDef('module_create_account_pro_success_title');
  ...
  public function execute()
  {
    ...
    if (isset($_GET['Account'], $_GET['CreatePro'], $_GET['Success'])) {
      ...
      ob_start();
      require_once($CLICSHOPPING_Template->getTemplateModules($this->group . '/content/create_account_pro_success'));

      $create_account .= ob_get_clean();

      $create_account .= '<!-- cap_create_account_pro_success end -->' . "\n";
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CREATE_ACCOUNT_PRO_SUCCESS_STATUS',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CREATE_ACCOUNT_PRO_SUCCESS_CONTENT_WIDTH',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_CREATE_ACCOUNT_PRO_SUCCESS_SORT_ORDER',
