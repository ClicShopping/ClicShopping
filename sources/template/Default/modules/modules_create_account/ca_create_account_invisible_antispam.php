  ...
  public function __construct()
  {
    ...
    if (\defined('CLICSHOPPING_APP_ANTISPAM_STATUS') && CLICSHOPPING_APP_ANTISPAM_STATUS == 'True') {
      if (\defined('CLICSHOPPING_APP_ANTISPAM_IN_STATUS') && CLICSHOPPING_APP_ANTISPAM_IN_STATUS == 'True') {
        if (\defined('CLICSHOPPING_APP_ANTISPAM_IN_CREATE_ACCOUNT') && CLICSHOPPING_APP_ANTISPAM_IN_CREATE_ACCOUNT == 'True') {
          if (\defined('MODULES_CREATE_ACCOUNT_INVISIBLE_ANTISPAM_STATUS')) {
            $this->enabled = \defined('MODULES_CREATE_ACCOUNT_INVISIBLE_ANTISPAM_STATUS') ? (MODULES_CREATE_ACCOUNT_INVISIBLE_ANTISPAM_STATUS == 'True') : false;
            $this->sort_order = \defined('MODULES_CREATE_ACCOUNT_INVISIBLE_ANTISPAM_SORT_ORDER') ? (int)MODULES_CREATE_ACCOUNT_INVISIBLE_ANTISPAM_SORT_ORDER : 0;
          }
        } else {
          $this->enabled = false;
        }
