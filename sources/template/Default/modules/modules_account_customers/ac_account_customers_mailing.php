...
class ac_account_customers_mailing
{
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_ACCOUNT_CUSTOMERS_MAILING_TITLE_STATUS',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_ACCOUNT_CUSTOMERS_MAILING_CONTENT_WIDTH',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_ACCOUNT_CUSTOMERS_MAILING_TITLE_SORT_ORDER',
  ...
  public function keys()
  {
    return array(
      ...
      'MODULE_ACCOUNT_CUSTOMERS_MAILING_TITLE_SORT_ORDER'
    );
  }
}
