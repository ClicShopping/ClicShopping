...
?>
  <div class="col-12 col-sm-<?php echo $bootstrap_column; ?> col-md-<?php echo $bootstrap_column; ?> p-1 pn-grid-list-item">
    ...
    <div class="card card-height">
      <div class="ModulesProductsSpecialsBoostrapColumn5CardHeight pn-main-flex-container">
        <div class="card-img-top ModulesProductsSpecialsBoostrapColumn5Image pn-image-block">
        ...
        <div class="pn-action-block">
          <div class="ModulesProductsSpecialsBoostrapColumn5TextPrice">
          ...
          <div class="text-center">
            ...
            <span class="ModulesProductsSpecialsBoostrapColumn5SubmitButton">
              <label for="ModulesProductsSpecialsBoostrapColumn5SubmitButton"><?php echo $submit_button; ?></label>
            </span>
