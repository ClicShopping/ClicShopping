 ...
 *
 *
 * This class handles the display and configuration of the "Products Specials" module in ClicShopping.
 * It manages the listing, sorting, and rendering of specials for customers, including
    ...
    if (isset($_GET['Products'], $_GET['Specials'])) {
      if (\defined('MODULE_PRODUCTS_SPECIAL_MAX_DISPLAY') && (int)MODULE_PRODUCTS_SPECIAL_MAX_DISPLAY != 0) {
        ...
        $context = new ProductsListingContext(
          constantsPrefix: 'MODULE_PRODUCTS_SPECIAL',
          cssContainerClass: 'ModulesProductsSpecialsContainer',
          cssHeadingClass: null,
          headingTextDef: null,
          tickerClasses: [
            'special'  => 'ModulesProductsSpecialsBootstrapTickerSpecial',
            'favorite' => 'ModulesProductsSpecialsBootstrapTickerFavorites',
            'featured' => 'ModulesProductsSpecialsBootstrapTickerFeatured',
            'new'      => 'ModulesProductsSpecialsBootstrapTickerNew',
          ],
          tickerPercentageClass: 'ModulesProductsFeaturedBootstrapTickerPourcentage',
          group: $this->group,
          trackingCode: $this->code,
          modulePosition: $module_position,
          sortOrder: (int)$this->sort_order,
          trackingWeight: 0.60,
          listingCommentLabel: 'Specials Products',
          hiddenUrlField: 'Products&Specials',
          displayCartButton: defined('MODULE_PRODUCTS_SPECIAL_DISPLAY_CART_BUTTON') && MODULE_PRODUCTS_SPECIAL_DISPLAY_CART_BUTTON === 'True',
          displayDetailsButton: defined('MODULE_PRODUCTS_SPECIAL_DISPLAY_DETAILS_BUTTON') && MODULE_PRODUCTS_SPECIAL_DISPLAY_DETAILS_BUTTON === 'True',
...
// number of sort criterias
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_DISPLAY_QUANTITY_INPUT',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_DISPLAY_DETAILS_BUTTON',
        'configuration_value' => 'True',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_DISPLAY_CART_BUTTON',
        'configuration_value' => 'True',
  ...
  public function keys()
  {
    return array(
      ...
      'MODULE_PRODUCTS_SPECIAL_DISPLAY_QUANTITY_INPUT',
      ...
      'MODULE_PRODUCTS_SPECIAL_DISPLAY_DETAILS_BUTTON',
      'MODULE_PRODUCTS_SPECIAL_DISPLAY_CART_BUTTON',
