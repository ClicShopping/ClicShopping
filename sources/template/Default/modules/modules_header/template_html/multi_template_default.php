  ...
  <div class="col-md-<?php echo $content_width; ?>">
    ...
    <div class="multiTemplateDefault-header-mobile-top-row d-md-none">
      ...
      <div class="d-flex align-items-center">
        <a class="multiTemplateDefault-mobile-login-icon-link" href="<?php echo CLICSHOPPING::link(null, 'Search&AdvancedSearch'); ?>" aria-label="<?php echo CLICSHOPPING::getDef('modules_header_multi_template_header_search'); ?>">
          <i class="bi bi-search multiTemplateDefault-icon"></i>
        </a>
        <?php
          if (!$CLICSHOPPING_Customer->isLoggedOn()) {
            ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <div class="row">
          <div class="col-md-12">
            <label for="inputAddressEmail" class="visually-hidden"></label>
            ...
            <span
              class="col-md-9 float-end"><?php echo HTML::inputField('email_address', null, 'id="inputAddressEmail" autocomplete="username" aria-describedby="inputAddressEmailLogin" placeholder="' . CLICSHOPPING::getDef('modules_header_multi_template_header_email_address') . '"', 'email'); ?></span>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <label for="current-password" class="visually-hidden"></label>
            ...
            <span
              class="col-md-9 float-end"><?php echo HTML::inputField('password', null, 'id="current-password" autocomplete="current-password" aria-describedby="inputAddressPasswordLogin" placeholder="' . CLICSHOPPING::getDef('modules_header_multi_template_account_password') . '"', 'password'); ?></span>
          </div>
        </div>
        <div class="mt-1"></div>
        <div class="row">
