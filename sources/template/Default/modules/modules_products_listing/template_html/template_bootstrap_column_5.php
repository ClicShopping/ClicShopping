  ...
  <div class="col-12 col-sm-<?php echo $bootstrap_column; ?> col-md-<?php echo $bootstrap_column; ?> p-1 pn-grid-list-item">
    ...
    <div class="card card-height">
      <div class="ModulesProductsNewBoostrapColumn5CardHeight pn-main-flex-container">
        <div class="card-img-top ModulesProductsListingBoostrapColumn5Image pn-image-block">
          <?php echo $products_image . $ticker; ?>
        </div>

        <div class="pn-text-block">
          <div class="card-body p-0">
            <div class="ModulesProductsListingBoostrapColumn5Title">
              <h3><?php echo $manufacturer_name; ?> <?php // echo HTML::link($products_name_url, $products_name); ?></h3>
            </div>
        ...
        <div class="pn-action-block">
          <div class="ModulesProductsListingBoostrapColumn5TextPrice">
