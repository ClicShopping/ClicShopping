...
class pn_products_new
{
  ...
  public function __construct()
  {
    ...
    if (\defined('MODULE_PRODUCTS_NEW_STATUS')) {
      $this->sort_order = \defined('MODULE_PRODUCTS_NEW_SORT_ORDER') ? (int)MODULE_PRODUCTS_NEW_SORT_ORDER : 0;
  ...
  public function execute()
  {
    ...
    if (isset($_GET['Products'], $_GET['ProductsNew'])) {
      if (\defined('MODULE_PRODUCTS_NEW_MAX_DISPLAY') && (int)MODULE_PRODUCTS_NEW_MAX_DISPLAY != 0) {
...
// display number of short description
          $products_short_description_number = \defined('MODULE_PRODUCTS_NEW_SHORT_DESCRIPTION') ? (int)MODULE_PRODUCTS_NEW_SHORT_DESCRIPTION : 0;
// delete words
          $delete_word = \defined('MODULE_PRODUCTS_NEW_SHORT_DESCRIPTION_DELETE_WORLDS') ? (int)MODULE_PRODUCTS_NEW_SHORT_DESCRIPTION_DELETE_WORLDS : 0;
// nbr of column to display  boostrap
          $bootstrap_column = \defined('MODULE_PRODUCTS_NEW_COLUMNS') ? (int)MODULE_PRODUCTS_NEW_COLUMNS : 0;
// initialisation des boutons
          $size_button = $CLICSHOPPING_ProductsCommon->getSizeButton('md');

// Template define
          $filename = $CLICSHOPPING_Template->getTemplateModulesFilename($this->group . '/template_html/' . MODULE_PRODUCTS_NEW_TEMPLATE);
          $counter = 1;
...
//Stock (good, alert, out of stock).
            $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_PRODUCTS_NEW_DISPLAY_STOCK, $products_id);
//Flash discount
...
// Display an input allowing for the customer to insert a quantity
            if ($CLICSHOPPING_ProductsCommon->getProductsQuantity() > 0) {
              $input_quantity = $CLICSHOPPING_ProductsFunctionTemplate->getDisplayInputQuantity(MODULE_PRODUCTS_NEW_DELETE_BUY_BUTTON, $products_id);
            } else {
              $input_quantity = '';
            }
...
// Ticker Image
            ...
            $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_PRODUCTS_NEW_POURCENTAGE_TICKER, $products_id, 'ModulesProductsFeaturedBootstrapTickerPourcentage');
...
// **************************
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_STATUS',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_COLUMNS',
        'configuration_value' => '6',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_SHORT_DESCRIPTION',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_TICKER',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_POURCENTAGE_TICKER',
        'configuration_value' => 'False',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_DISPLAY_STOCK',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_LIST_DATE_ADDED',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_LIST_PRICE',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '6',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_LIST_MODEL',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '7',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_LIST_QUANTITY',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '8',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_LIST_WEIGHT',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '9',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_IMAGE_MEDIUM',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_DELETE_BUY_BUTTON',
        'configuration_value' => 'False',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_SORT_ORDER',
  ...
  {
    return array(
      'MODULE_PRODUCTS_NEW_STATUS',
      'MODULE_PRODUCTS_NEW_TEMPLATE',
      'MODULE_PRODUCTS_NEW_MAX_DISPLAY',
      'MODULE_PRODUCTS_NEW_COLUMNS',
      'MODULE_PRODUCTS_NEW_SHORT_DESCRIPTION',
      'MODULE_PRODUCTS_NEW_SHORT_DESCRIPTION_DELETE_WORLDS',
      'MODULE_PRODUCTS_NEW_TICKER',
      'MODULE_PRODUCTS_NEW_POURCENTAGE_TICKER',
      'MODULE_PRODUCTS_NEW_DISPLAY_STOCK',
      'MODULE_PRODUCTS_NEW_LIST_DATE_ADDED',
      'MODULE_PRODUCTS_NEW_LIST_PRICE',
      'MODULE_PRODUCTS_NEW_LIST_MODEL',
      'MODULE_PRODUCTS_NEW_LIST_QUANTITY',
      'MODULE_PRODUCTS_NEW_LIST_WEIGHT',
      'MODULE_PRODUCTS_NEW_IMAGE_MEDIUM',
      'MODULE_PRODUCTS_NEW_DELETE_BUY_BUTTON',
      'MODULE_PRODUCTS_NEW_SORT_ORDER'
    );
  }
}
