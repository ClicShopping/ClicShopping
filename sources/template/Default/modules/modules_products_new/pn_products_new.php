...
class pn_products_new
{
  ...
  public function __construct()
  {
    ...
    if (\defined('MODULE_PRODUCTS_NEW_STATUS')) {
      ...
      $this->enabled = \defined('MODULE_PRODUCTS_NEW_STATUS') ? (MODULE_PRODUCTS_NEW_STATUS == 'True') : false;
    }
  }
    ...
    if (isset($_GET['Products'], $_GET['ProductsNew'])) {
      if (\defined('MODULE_PRODUCTS_NEW_MAX_DISPLAY') && (int)MODULE_PRODUCTS_NEW_MAX_DISPLAY != 0) {
        ...
        $context = new ProductsListingContext(
          constantsPrefix: 'MODULE_PRODUCTS_NEW',
          cssContainerClass: 'ModulesProductsNewContainer',
          cssHeadingClass: null,
          headingTextDef: null,
          tickerClasses: [
            'special'  => 'ModulesProductsNewBootstrapTickerSpecial',
            'favorite' => 'ModulesProductsNewBootstrapTickerFavorite',
            'featured' => 'ModulesProductsNewBootstrapTickerFeatured',
            'new'      => 'ModulesProductsNewBootstrapTickerNew',
          ],
          tickerPercentageClass: 'ModulesProductsNewBootstrapTickerPourcentage',
          group: $this->group,
          ...
          hiddenUrlField: 'Products&ProductsNew',
          displayCartButton: defined('MODULE_PRODUCTS_NEW_DISPLAY_CART_BUTTON') && MODULE_PRODUCTS_NEW_DISPLAY_CART_BUTTON === 'True',
          displayDetailsButton: defined('MODULE_PRODUCTS_NEW_DISPLAY_DETAILS_BUTTON') && MODULE_PRODUCTS_NEW_DISPLAY_DETAILS_BUTTON === 'True',
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_DISPLAY_QUANTITY_INPUT',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_DISPLAY_DETAILS_BUTTON',
        'configuration_value' => 'True',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_NEW_DISPLAY_CART_BUTTON',
        'configuration_value' => 'True',
  ...
  public function keys()
  {
    return array(
      ...
      'MODULE_PRODUCTS_NEW_DISPLAY_QUANTITY_INPUT',
      ...
      'MODULE_PRODUCTS_NEW_DISPLAY_DETAILS_BUTTON',
      'MODULE_PRODUCTS_NEW_DISPLAY_CART_BUTTON',
