...
// **************************
      ...
      $data .= '</div>';
      $data .= '<div class="card-footer boxeBottomContentsFeatured"></div>';
      $data .= '</div>' . "\n";
      $data .= '</section>' . "\n";
      $data .= '<!-- Boxe Products featured end -->' . "\n";
  ...
  {
    return array('MODULE_BOXES_PRODUCTS_FEATURED_STATUS',
      'MODULE_BOXES_PRODUCTS_FEATURED_CONTENT_PLACEMENT',
      'MODULE_BOXES_PRODUCTS_FEATURED_BANNER_GROUP',
      'MODULE_BOXES_PRODUCTS_FEATURED_DETAIL_BUTTON',
      'MODULE_BOXES_PRODUCTS_FEATURED_MAX_DISPLAY_LIMIT',
      'MODULE_BOXES_PRODUCTS_FEATURED_TICKER',
      'MODULE_BOXES_PRODUCTS_FEATURED_POURCENTAGE_TICKER',
      'MODULE_BOXES_PRODUCTS_FEATURED_SORT_ORDER',
      'MODULE_BOXES_PRODUCTS_FEATURED_DISPLAY_PAGES');
  }
}
