...
class bm_products_favorites
{
  ...
  public function execute()
  {
    ...
    if ($CLICSHOPPING_Customer->getCustomersGroupID() != 0) {
      ...
      $Qproducts->bindInt(':limit', defined('MODULE_BOXES_PRODUCTS_FAVORITES_MAX_DISPLAY_LIMIT') ? (int)MODULE_BOXES_PRODUCTS_FAVORITES_MAX_DISPLAY_LIMIT : 0);
      $Qproducts->execute();
    ...
    if ($Qproducts->rowCount() > 0) {
      ...
      if ($CLICSHOPPING_Service->isStarted('Banner')) {
        if ($banner = $CLICSHOPPING_Banner->bannerExists('dynamic', defined('MODULE_BOXES_PRODUCTS_FAVORITES_BANNER_GROUP') ? MODULE_BOXES_PRODUCTS_FAVORITES_BANNER_GROUP : '')) {
      ...
      while ($Qproducts->fetch()) {
        ...
        } elseif ($CLICSHOPPING_ProductsCommon->getProductsTickerFeatured($products_id) == 'True' && defined('MODULE_BOXES_PRODUCTS_FAVORITES_TICKER') && MODULE_BOXES_PRODUCTS_FAVORITES_TICKER == 'True') {
        ...
        } elseif ($CLICSHOPPING_ProductsCommon->getProductsTickerProductsNew($products_id) == 'True' && defined('MODULE_BOXES_PRODUCTS_FAVORITES_TICKER') && MODULE_BOXES_PRODUCTS_FAVORITES_TICKER == 'True') {
        ...
        if (defined('MODULE_BOXES_PRODUCTS_FAVORITES_POURCENTAGE_TICKER') && MODULE_BOXES_PRODUCTS_FAVORITES_POURCENTAGE_TICKER == 'True' && !\is_null($CLICSHOPPING_ProductsCommon->getProductsTickerSpecialsPourcentage($products_id))) {
