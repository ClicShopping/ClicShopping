...
?>
  <div class="col-12 col-sm-<?php echo $bootstrap_column; ?> col-md-<?php echo $bootstrap_column; ?> p-1 pn-grid-list-item">
    ...
    <div class="card card-height">
      <div class="ModulesProductsFeaturedBoostrapColumn5CardHeight pn-main-flex-container">
        <div class="card-img-top ModulesProductsFeaturedBoostrapColumn5Image pn-image-block">
          <?php echo $products_image . $ticker; ?>
        </div>

        <div class="pn-text-block">
          <div class="card-body p-0">
            <div class="ModulesProductsFeaturedBoostrapColumn5Title">
              <h3><?php echo HTML::link($products_name_url, $products_name); ?></h3>
            </div>
            <div class="ModulesReviewsRow"><?php echo $avg_reviews; ?></div>
            <div class="mt-2"></div>
            <?php if (!empty($products_short_description)) { ?>
              <div class="ModulesProductsFeaturedBoostrapColumn5ShortDescription">
        ...
        <div class="pn-action-block">
          <div class="ModulesProductsFeaturedBoostrapColumn5TextPrice">
          ...
          <div class="text-center">
            ...
            <span class="ModulesProductsFeaturedBoostrapColumn5SubmitButton">
              <label for="ModulesProductsFeaturedBoostrapColumn5SubmitButton"><?php echo $submit_button; ?></label>
            </span>
