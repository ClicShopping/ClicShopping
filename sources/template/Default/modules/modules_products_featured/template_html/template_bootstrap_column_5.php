      ...
      <div class="ModulesProductsFeaturedBoostrapColumn5CardHeight">
        ...
        <div>
          ...
          if (!empty($min_order_quantity_products_display)) {
            ?>
            <div
              class="ModulesProductsFeaturedBoostrapColumn5QuantityMinOrder"><?php echo $min_order_quantity_products_display; ?></div>
            <?php
          }
        ...
        <div>
          <div
            class="ModulesProductsFeaturedBoostrapColumn5TextPrice"><?php echo CLICSHOPPING::getDef('text_price') . ' ' . $product_price; ?></div>
        </div>
        <?php echo $form; ?>
        <div class="form-group form-group-center">
          <span
            class="ModulesProductsFeaturedBoostrapColumn5QuantityMinOrder"><?php echo $input_quantity; ?>&nbsp; </span>
          <span class="ModulesProductsFeaturedBoostrapColumn5ViewDetails"><?php echo $button_small_view_details; ?>&nbsp; </span>
          <span class="ModulesProductsFeaturedBoostrapColumn5SubmitButton"><label
              for="ModulesProductsFeaturedBoostrapColumn5SubmitButton"><?php echo $submit_button; ?></label></span>
        </div>
        <?php echo $endform; ?>
      </div>
    </div>
