 ...
 * It manages the listing, sorting, and rendering of featured products for customers, including
  ...
  class pf_products_featured
{
    ...
    if (isset($_GET['Products'], $_GET['Featured'])) {
      if (\defined('MODULE_PRODUCTS_FEATURED_MAX_DISPLAY') && (int)MODULE_PRODUCTS_FEATURED_MAX_DISPLAY != 0) {
        ...
        $context = new ProductsListingContext(
          constantsPrefix: 'MODULE_PRODUCTS_FEATURED',
          cssContainerClass: 'ModulesProductsFeaturedContainer',
          cssHeadingClass: null,
          headingTextDef: null,
          tickerClasses: [
            'special'  => 'ModulesProductsFavoritesBootstrapTickerSpecial',
            'favorite' => 'ModulesProductsFeaturedBootstrapTickerFavorite',
            'featured' => 'ModulesProductsFeaturedBootstrapTickerFeatured',
            'new'      => 'ModulesProductsFeaturedBootstrapTickerNew',
          ],
          ...
          trackingWeight: 0.45,
          listingCommentLabel: 'New Featured',
          hiddenUrlField: 'Products&Featured',
          displayCartButton: defined('MODULE_PRODUCTS_FEATURED_DISPLAY_CART_BUTTON') && MODULE_PRODUCTS_FEATURED_DISPLAY_CART_BUTTON === 'True',
          displayDetailsButton: defined('MODULE_PRODUCTS_FEATURED_DISPLAY_DETAILS_BUTTON') && MODULE_PRODUCTS_FEATURED_DISPLAY_DETAILS_BUTTON === 'True',
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_FEATURED_DISPLAY_QUANTITY_INPUT',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_FEATURED_DISPLAY_DETAILS_BUTTON',
        'configuration_value' => 'True',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_FEATURED_DISPLAY_CART_BUTTON',
        'configuration_value' => 'True',
  ...
  public function keys()
  {
    return array(
      ...
      'MODULE_PRODUCTS_FEATURED_DISPLAY_QUANTITY_INPUT',
      ...
      'MODULE_PRODUCTS_FEATURED_DISPLAY_DETAILS_BUTTON',
      'MODULE_PRODUCTS_FEATURED_DISPLAY_CART_BUTTON',
