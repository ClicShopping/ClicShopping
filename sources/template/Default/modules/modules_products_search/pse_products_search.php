 ...
 *
 *
 * This class handles the display and configuration of the "Products Search" module in ClicShopping.
 * It manages the listing, sorting, and rendering of products search for customers, including
...
class pse_products_search
{
    ...
    if (isset($_GET['Q'])) {
      ...
      if ($max_display != 0 && (isset($_GET['Search']) || isset($_GET['Q']))) {
        $context = new ProductsListingContext(
          constantsPrefix: 'MODULE_PRODUCTS_SEARCH',
          cssContainerClass: 'ModulesProductsSearchContainer',
          cssHeadingClass: null,
          headingTextDef: null,
          tickerClasses: [
            'special'  => 'ModulesProductsSearchBootstrapTickerSpecial',
            'favorite' => 'ModulesProductsSearchBootstrapTickerFavorite',
            'featured' => 'ModulesProductsSearchBootstrapTickerFeatured',
            'new'      => 'ModulesProductsSearchBootstrapTickerNew',
          ],
          tickerPercentageClass: 'ModulesProductsSearchBootstrapTickerPourcentage',
          group: $this->group,
          trackingCode: $this->code,
          modulePosition: $module_position,
          sortOrder: (int)$this->sort_order,
          trackingWeight: 0.45,
          listingCommentLabel: 'Search',
          hiddenUrlField: 'Search&Q',
          displayCartButton: defined('MODULE_PRODUCTS_SEARCH_DISPLAY_CART_BUTTON') && MODULE_PRODUCTS_SEARCH_DISPLAY_CART_BUTTON === 'True',
          displayDetailsButton: defined('MODULE_PRODUCTS_SEARCH_DISPLAY_DETAILS_BUTTON') && MODULE_PRODUCTS_SEARCH_DISPLAY_DETAILS_BUTTON === 'True',
      ...
      $new_prods_content .= '<!--  Products search End -->' . "\n";
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_STATUS',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_TEMPLATE',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_MAX_DISPLAY',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_DISPLAY_QUANTITY_INPUT',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_LIST_NAME',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        'configuration_title' => 'Please indicate a arrival date sort order',
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_LIST_DATE_ADDED',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '5',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_LIST_PRICE',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '6',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_LIST_MODEL',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '7',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_LIST_QUANTITY',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '8',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        'configuration_title' => 'Please indicate a brands sort order',
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_LIST_MANUFACTURER',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '9',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_LIST_WEIGHT',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '10',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_IMAGE_MEDIUM',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_DISPLAY_DETAILS_BUTTON',
        'configuration_value' => 'True',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_DISPLAY_CART_BUTTON',
        'configuration_value' => 'True',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_SEARCH_SORT_ORDER',
  ...
  public function keys()
  {
    return array(
      ...
      'MODULE_PRODUCTS_SEARCH_COLUMNS',
      'MODULE_PRODUCTS_SEARCH_SHORT_DESCRIPTION',
      'MODULE_PRODUCTS_SEARCH_DISPLAY_QUANTITY_INPUT',
      'MODULE_PRODUCTS_SEARCH_TICKER',
      'MODULE_PRODUCTS_SEARCH_POURCENTAGE_TICKER',
      'MODULE_PRODUCTS_SEARCH_DISPLAY_STOCK',
      'MODULE_PRODUCTS_SEARCH_LIST_NAME',
      'MODULE_PRODUCTS_SEARCH_LIST_DATE_ADDED',
      'MODULE_PRODUCTS_SEARCH_LIST_PRICE',
      'MODULE_PRODUCTS_SEARCH_LIST_MODEL',
      'MODULE_PRODUCTS_SEARCH_LIST_QUANTITY',
      'MODULE_PRODUCTS_SEARCH_LIST_MANUFACTURER',
      'MODULE_PRODUCTS_SEARCH_LIST_WEIGHT',
      'MODULE_PRODUCTS_SEARCH_IMAGE_MEDIUM',
      'MODULE_PRODUCTS_SEARCH_DISPLAY_DETAILS_BUTTON',
      'MODULE_PRODUCTS_SEARCH_DISPLAY_CART_BUTTON',
      'MODULE_PRODUCTS_SEARCH_SORT_ORDER'
    );
  }
}
