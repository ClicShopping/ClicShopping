...
// Ticker Image
            ...
            $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_PRODUCTS_SEARCH_POURCENTAGE_TICKER, $products_id, 'ModulesProductsFeaturedBootstrapTickerPourcentage');
...
// **************************
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        'configuration_title' => 'Veuillez indiquer une ordre tri selon le nom du produit',
  ...
  public function keys()
  {
    return array(
      ...
      'MODULE_PRODUCTS_SEARCH_SHORT_DESCRIPTION_DELETE_WORLDS',
      ...
      'MODULE_PRODUCTS_SEARCH_DELETE_BUY_BUTTON',
