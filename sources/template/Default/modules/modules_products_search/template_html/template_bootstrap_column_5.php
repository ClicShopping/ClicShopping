...
?>
  <div class="col-12 col-sm-<?php echo $bootstrap_column; ?> col-md-<?php echo $bootstrap_column; ?> p-1 pn-grid-list-item">
    ...
    <div class="card card-height">
      <div class="ModulesProductsSearchBoostrapColumn5CardHeight pn-main-flex-container">
        <div class="card-img-top ModulesProductsSearchBoostrapColumn5Image pn-image-block">
        ...
        <div class="pn-action-block">
          <div class="ModulesProductsSearchBoostrapColumn5TextPrice">
          ...
          <div class="text-center">
            ...
            <span class="ModulesProductsNewBoostrapColumn5SubmitButton">
              <label for="ModulesProductsSearchBoostrapColumn5SubmitButton"><?php echo $submit_button; ?></label>
            </span>
