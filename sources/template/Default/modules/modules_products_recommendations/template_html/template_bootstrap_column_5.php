...
?>
  <div class="col-12 col-sm-<?php echo $bootstrap_column; ?> col-md-<?php echo $bootstrap_column; ?> p-1 pn-grid-list-item">
    ...
    <div class="card card-height">
      <div class="ModulesProductsRecommendationsBoostrapColumn5CardHeight pn-main-flex-container">
        <div class="card-img-top ModulesProductsRecommendationsBoostrapColumn5Image pn-image-block">
        ...
        <div class="pn-text-block">
          ...
          <div class="ModulesProductsRecommendationsBoostrapColumn5StockImage"><?php echo $products_stock; ?></div>
            ...
            <?php if (!empty($min_order_quantity_products_display)) { ?>
              <div class="ModulesProductsRecommendationsBoostrapColumn5QuantityMinOrder"><?php echo $min_order_quantity_products_display; ?></div>
            <?php } ?>
        ...
        <div class="pn-action-block">
          <div class="ModulesProductsRecommendationsBoostrapColumn5TextPrice">
            <?php echo CLICSHOPPING::getDef('text_price') . ' ' . $product_price; ?>
          </div>

          <?php echo $form; ?>
          <div class="text-center">
            <span class="ModulesProductsRecommendationsBoostrapColumn5QuantityMinOrder"><?php echo $input_quantity; ?>&nbsp; </span>
            <span class="ModulesProductsRecommendationsBoostrapColumn5SubmitButton">
              <label for="ModulesProductsRecommendationsBoostrapColumn5SubmitButton"><?php echo $submit_button; ?></label>
            </span>
