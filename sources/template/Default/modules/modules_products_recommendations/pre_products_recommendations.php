...
class pre_products_recommendations
{
  public string $code;
  public string $group;
  public $title;
  ...
  public function __construct()
  {
    ...
    $this->title = CLICSHOPPING::getDef('module_products_recommendations_title');
    ...
    if (isset($_GET['Products'], $_GET['Recommendations'])) {
      if (\defined('MODULE_PRODUCTS_RECOMMENDATIONS_MAX_DISPLAY') && (int)MODULE_PRODUCTS_RECOMMENDATIONS_MAX_DISPLAY != 0) {
        ...
        if ($listingTotalRow > 0) {
          $new_prods_content .= '<div class="col-md-7 float-start">';
          ...
          $new_prods_content .= '<div class="col-md-3 float-end">';
...
// number of sort criterias
          $column_list = RecommendationsShop::getCountColumnList();
...
// Template define
          $filename = $CLICSHOPPING_Template->getTemplateModulesFilename($this->group . '/template_html/' . MODULE_PRODUCTS_RECOMMENDATIONS_TEMPLATE);
          $counter = 1;

          while ($Qlisting->fetch()) {
            $products_id = $Qlisting->valueInt('products_id');
            //trackingProduct
            ProductsTracking::insertProductTracking($products_id,  $this->code, $module_position, $this->sort_order, $CLICSHOPPING_Language->getId(), null, 0.55);
...
//Stock (good, alert, out of stock).
            $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_PRODUCTS_RECOMMENDATIONS_DISPLAY_STOCK, $products_id);
//Flash discount
...
// Display an input allowing for the customer to insert a quantity
            if ($CLICSHOPPING_ProductsCommon->getProductsQuantity() > 0) {
              $input_quantity = $CLICSHOPPING_ProductsFunctionTemplate->getDisplayInputQuantity(MODULE_PRODUCTS_RECOMMENDATIONS_DELETE_BUY_BUTTON, $products_id);
            } else {
              $input_quantity = '';
            }
...
// **************************
            ...
            if (MODULE_PRODUCTS_RECOMMENDATIONS_DELETE_BUY_BUTTON == 'False') {
              if ($CLICSHOPPING_ProductsCommon->getProductsMinimumQuantity($products_id) != 0 && $CLICSHOPPING_ProductsCommon->getProductsQuantity($products_id) != 0) {
                if ($CLICSHOPPING_ProductsAttributes->getHasProductAttributes($products_id) === false) {
                  ...
                  if (isset($_GET['Recommendations'])) $form .= HTML::hiddenField('url', 'Products&ProductsRecommendations');
                  $endform = '</form>';
...
// See the button more view details
            $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_PRODUCTS_RECOMMENDATIONS_DELETE_BUY_BUTTON, $products_id);

// Display the image
            $products_image = $CLICSHOPPING_ProductsFunctionTemplate->getImage(MODULE_PRODUCTS_RECOMMENDATIONS_IMAGE_MEDIUM, $products_id);

// Ticker Image
            $products_image .= $CLICSHOPPING_ProductsFunctionTemplate->getTicker(MODULE_PRODUCTS_RECOMMENDATIONS_TICKER, $products_id, 'ModulesProductsNewBootstrapTickerSpecial', 'ModulesProductsNewBootstrapTickerFavorite', 'ModulesProductsNewBootstrapTickerFeatured', 'ModulesProductsNewBootstrapTickerNew');

            $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_PRODUCTS_RECOMMENDATIONS_POURCENTAGE_TICKER, $products_id, 'ModulesProductsFeaturedBootstrapTickerPourcentage');
...
// **************************
  ...
  {
    return \defined('MODULE_PRODUCTS_RECOMMENDATIONS_STATUS');
  }
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_STATUS',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_TEMPLATE',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_COLUMNS',
        'configuration_value' => '6',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_SHORT_DESCRIPTION',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_SHORT_DESCRIPTION_DELETE_WORLDS',
        'configuration_value' => '0',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_TICKER',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_POURCENTAGE_TICKER',
        'configuration_value' => 'False',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_DISPLAY_STOCK',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_LIST_DATE_ADDED',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_LIST_PRICE',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '6',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_LIST_MODEL',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '7',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_LIST_QUANTITY',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '8',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_LIST_WEIGHT',
        'configuration_value' => '0',
        'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
        'configuration_group_id' => '6',
        'sort_order' => '9',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_DELETE_BUY_BUTTON',
        'configuration_value' => 'False',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_SORT_ORDER',
  ...
  {
    return array(
      'MODULE_PRODUCTS_RECOMMENDATIONS_STATUS',
      'MODULE_PRODUCTS_RECOMMENDATIONS_TEMPLATE',
      'MODULE_PRODUCTS_RECOMMENDATIONS_MAX_DISPLAY',
      'MODULE_PRODUCTS_RECOMMENDATIONS_COLUMNS',
      'MODULE_PRODUCTS_RECOMMENDATIONS_SHORT_DESCRIPTION',
      'MODULE_PRODUCTS_RECOMMENDATIONS_SHORT_DESCRIPTION_DELETE_WORLDS',
      'MODULE_PRODUCTS_RECOMMENDATIONS_TICKER',
      'MODULE_PRODUCTS_RECOMMENDATIONS_POURCENTAGE_TICKER',
      'MODULE_PRODUCTS_RECOMMENDATIONS_DISPLAY_STOCK',
      'MODULE_PRODUCTS_RECOMMENDATIONS_LIST_DATE_ADDED',
      'MODULE_PRODUCTS_RECOMMENDATIONS_LIST_PRICE',
      'MODULE_PRODUCTS_RECOMMENDATIONS_LIST_MODEL',
      'MODULE_PRODUCTS_RECOMMENDATIONS_LIST_QUANTITY',
      'MODULE_PRODUCTS_RECOMMENDATIONS_LIST_WEIGHT',
      'MODULE_PRODUCTS_RECOMMENDATIONS_IMAGE_MEDIUM',
      'MODULE_PRODUCTS_RECOMMENDATIONS_DELETE_BUY_BUTTON',
      'MODULE_PRODUCTS_RECOMMENDATIONS_SORT_ORDER'
    );
  }
}
