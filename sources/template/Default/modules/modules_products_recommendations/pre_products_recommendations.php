 ...
 *
 *
 * This class handles the display and configuration of the "Products Recommendations" module in ClicShopping.
 * It manages the listing, sorting, and rendering of products recommendations for customers, including
...
class pre_products_recommendations
{
  ...
  public function __construct()
  {
    ...
    if (\defined('MODULE_PRODUCTS_RECOMMENDATIONS_STATUS')) {
      ...
      $this->enabled = \defined('MODULE_PRODUCTS_RECOMMENDATIONS_STATUS') ? (MODULE_PRODUCTS_RECOMMENDATIONS_STATUS == 'True') : false;
    }
  }
    ...
    if (isset($_GET['Products'], $_GET['Recommendations'])) {
      if (\defined('MODULE_PRODUCTS_RECOMMENDATIONS_MAX_DISPLAY') && (int)MODULE_PRODUCTS_RECOMMENDATIONS_MAX_DISPLAY != 0) {
        ...
        $context = new ProductsListingContext(
          constantsPrefix: 'MODULE_PRODUCTS_RECOMMENDATIONS',
          cssContainerClass: 'ModulesProductsRecommandationsContainer',
          cssHeadingClass: null,
          headingTextDef: null,
          tickerClasses: [
            'special'  => 'ModulesProductsRecommandationsBootstrapTickerSpecial',
            'favorite' => 'ModulesProductsRecommandationsBootstrapTickerFavorite',
            'featured' => 'ModulesProductsRecommandationsBootstrapTickerFeatured',
            'new'      => 'ModulesProductsRecommandationsBootstrapTickerNew',
          ],
          tickerPercentageClass: 'ModulesProductsRecommandationsBootstrapTickerPourcentage',
          group: $this->group,
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_DISPLAY_QUANTITY_INPUT',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_DISPLAY_DETAILS_BUTTON',
        'configuration_value' => 'True',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_PRODUCTS_RECOMMENDATIONS_DISPLAY_CART_BUTTON',
        'configuration_value' => 'True',
  ...
  public function keys()
  {
    return array(
      ...
      'MODULE_PRODUCTS_RECOMMENDATIONS_DISPLAY_QUANTITY_INPUT',
      ...
      'MODULE_PRODUCTS_RECOMMENDATIONS_DISPLAY_DETAILS_BUTTON',
      'MODULE_PRODUCTS_RECOMMENDATIONS_DISPLAY_CART_BUTTON',
