...
class mc_new_products
{
  ...
  public function __construct()
  {
    ...
    if (\defined('MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_STATUS')) {
      $this->sort_order = \defined('MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_SORT_ORDER') ? (int)MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_SORT_ORDER : 0;
      $this->enabled = \defined('MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_STATUS') ? (MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_STATUS == 'True') : false;
    }
  }
  ...
  public function execute()
  {
    ...
    if (CLICSHOPPING::getBaseNameIndex() && $CLICSHOPPING_Category->getPath()) {
      if (\defined('MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_MAX_DISPLAY') && (int)MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_MAX_DISPLAY != 0) {
        $context = new ProductsListingContext(
          constantsPrefix: 'MODULE_INDEX_CATEGORIES_NEW_PRODUCTS',
          cssContainerClass: 'ModuleIndexCategoriesProductsNewContainer5',
          cssHeadingClass: null,
          headingTextDef: null,
          tickerClasses: [
            'special'  => 'ModulesIndexCategoriesNewProductsProductsBootstrapTickerSpecial',
            'favorite' => 'ModulesIndexCategoriesNewProductsBootstrapTickerFavorite',
            'featured' => 'ModulesIndexCategoriesNewProductsBootstrapTickerFeatured',
            'new'      => 'ModulesIndexCategoriesNewProductsBootstrapTickerNew',
          ],
          tickerPercentageClass: 'ModulesIndexCategoriesBootstrapTickerPourcentage',
          group: $this->group,
          ...
          displayCartButton: defined('MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_CART_BUTTON') && MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_CART_BUTTON === 'True',
          displayDetailsButton: defined('MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_DETAILS_BUTTON') && MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_DETAILS_BUTTON === 'True',
          displaySortBar: defined('MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_FILTER') && MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_FILTER === 'True',
...
//Depth = products
            $Qproduct = $CLICSHOPPING_Db->prepare('select p.products_id,
                                                      ...
                                                      from :table_products p left join :table_specials s on p.products_id = s.products_id left join :table_manufacturers m on p.manufacturers_id = m.manufacturers_id
...
//Depth = listing
        ...
        if ($Qproduct->rowCount() > 0) {
          if (\defined('MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_MAX_DISPLAY') && (int)MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_MAX_DISPLAY > 0) {
            ...
            if (MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_FRONT_TITLE != 'False') {
              $heading = '<div class="page-title ModuleIndexCategoriesProductsNewHeading"><h2>' . sprintf(CLICSHOPPING::getDef('module_index_categories_products_heading_title'), DateTime::getNow(CLICSHOPPING::getDef('date_format_long'))) . '</h2></div>';
            }
  ...
  public function install()
  {
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_QUANTITY_INPUT',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_DETAILS_BUTTON',
        'configuration_value' => 'True',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_CART_BUTTON',
        'configuration_value' => 'True',
    ...
    $CLICSHOPPING_Db->save('configuration', [
        ...
        'configuration_key' => 'MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_FILTER',
        'configuration_value' => 'False',
        'configuration_description' => 'Display a sort dropdown (manufacturer, price, date) above the listing',
        'configuration_group_id' => '6',
        'sort_order' => '14',
        'set_function' => 'clic_cfg_set_boolean_value(array(\'True\', \'False\'))',
        'date_added' => 'now()'
  ...
  public function keys()
  {
    return array('MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_STATUS',
      ...
      'MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_QUANTITY_INPUT',
      ...
      'MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_DETAILS_BUTTON',
      'MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_CART_BUTTON',
      'MODULE_INDEX_CATEGORIES_NEW_PRODUCTS_DISPLAY_FILTER',
